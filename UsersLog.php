...
<section class="container py-lg-5">>
  <!--User table-->
    <h1 class="slideInDown animated">Here are the Patients logs</h1>
      ...
      <div class="modal-dialog modal-dialog-centered modal-lg animate" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h3 class="modal-title" id="exampleModalLongTitle">Filter Your Patients Log:</h3>
                    ...
                    <div class="panel panel-primary">
                      <div class="panel-heading">
                        ...
                        <div class="time">
                          ...
                          <label for="radio-one">Access-Time</label>
                          <input type="radio" id="radio-two" name="time_sel" class="time_sel" value="Time_out" />
                          <label for="radio-two">Enroll-Time</label>
                        </div>
                      </div>
                      <div class="panel-body">
