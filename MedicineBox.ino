...
const char *ssid = "SADIT";
const char *password = "Maleka@7575";
const char* device_token  = "23378398";
//************************************************************************
String getData, Link;
String URL = "http://192.168.0.103/medicinebox/getdata.php"; //computer IP or the server domain
//************************************************************************
...
void SendFingerprintID( int finger ){
  ...
  //  Serial.println(user_name);
          digitalWrite(LOCK, HIGH);   // turn the LED on 
  delay(1000);
      display.clearDisplay();
      ...
      display.print(F("Accessed"));
      display.display();
    }
    else if (payload.substring(0, 6) == "logout") {
      String user_name = payload.substring(6);
  //  Serial.println(user_name);
        digitalWrite(LOCK, LOW);    // turn the LED off 
  delay(1000); 
      display.clearDisplay();
      display.setTextSize(2);             // Normal 2:2 pixel scale
      display.setTextColor(WHITE);        // Draw white text
